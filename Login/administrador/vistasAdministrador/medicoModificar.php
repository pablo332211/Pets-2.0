            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="zmdi zmdi-edit"></i> &nbsp; RESULTADO
                    </h3>
                </div>
                <form action="" name="medico" id="medico" method="POST">
                    <fieldset>
                        <legend><i class="zmdi zmdi-account-box"></i> &nbsp;Modificar documentos</legend>
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xs-12">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="NombreA_Medico" id="NombreA_Medico" value="<?php echo $obj->NombreA_Medico; ?>" maxlength="30">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Segundo nombre</label>
                                        <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="NombreB_Medico" id="NombreB_Medico" value="<?php echo $obj->NombreB_Medico; ?>" maxlength="30">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="ApellidoA_Medico" id="ApellidoA_Medico" value="<?php echo $obj->ApellidoA_Medico; ?>" maxlength="30">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Segundo apellido*</label>
                                        <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="ApellidoB_Medico" id="ApellidoB_Medico" value="<?php echo $obj->ApellidoB_Medico; ?>" maxlength="30">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input class="form-control" type="email" name="Correo_Medico" id="Correo_Medico" value="<?php echo  $obj->Correo_Medico; ?>" maxlength="30">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input class="form-control" type="text" name="Telefono_Medico" id="Telefono_Medico" value="<?php echo  $obj->Telefono_Medico ?>" maxlength="15">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input class="form-control" type="text" name="Celular_Medico" id="Celular_Medico" value="<?php echo $obj->Celular_Medico; ?>" maxlength="15">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input class="form-control" type="password" name="Contrasena_Medico" id="Contrasena_Medico" value="<?php echo $obj->Contrasena_Medico ?>" maxlength="15">
                                    </div>
                                </div>
                    ...
                    <p class="text-center" style="margin-top: 20px;">
                        <button type="submit" class="btn btn-info btn-raised btn-sm" name="modificarMedico"><i class="zmdi zmdi-"></i>Guardar</button>
                    </p>
                    <p class="text-center" style="margin-top: 20px;">
                        <a href="administradorDesk.php">
                            <button type="button" class="btn btn-info btn-raised btn-sm" name="volver"><i class="zmdi zmdi-"></i> Inicio</button></a>
                    </p>
                </form>
