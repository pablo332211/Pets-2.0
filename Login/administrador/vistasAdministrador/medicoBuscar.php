...
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from medico where Documento_Medico ");
        ...
        <div class="container-fluid">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="zmdi zmdi-search"></i> &nbsp; Buscar Medico</h3>
                </div>

                <div class="container-fluid">
                    <form class="well" method="GET" action="medicoLista.php">


                        <div class="row">
                            <div class="col-xs-12 col-md-8 col-md-offset-2">
                                <div class="form-group label-floating">
                                    <span class="control-label">DNI MEDICO</span>
                                    <input class="form-control" type="text" name="Documento_Medico" id="Documento_Medico" value="<?php echo $obj->Documento_Medico;  ?>" pattern="[0-9-]{1,20}" />
                                </div>
                            </div>
                            <div class="col-xs-12">
                                <p class="text-center">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE MEDICOS
                            </h3>
                        </div>
