    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h1 class="text-titles">Cita Medica de <?php echo $arregloHC[2] ?></h1>
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="Modificar_CitaMedicaHC.php?key=<?php echo urldecode($arreglo[1]) ?>&CodHC=<?php echo urldecode($arregloHC[0]) ?>&DocM=<?php echo urldecode($DocM) ?>" class="btn btn-success btn-raised btn-xs">
                                                <i class="zmdi zmdi-check" type="button" name="modificar" value="modificar"></i>
                                            </a>
                                        </td>
                                        <td>
                                        <a href="Eliminar_CitaMedicaHC.php?key=<?php echo urldecode($arreglo[1])?>&CodHC=<?php echo urldecode($arregloHC[0])?>&DocM=<?php echo urldecode($DocM)?>" class="btn btn-danger btn-raised btn-xs">  
