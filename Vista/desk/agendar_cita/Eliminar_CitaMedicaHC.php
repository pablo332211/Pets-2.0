    ...
    <section class="full-box dashboard-contentPage">
       ...
       <div class="container-fluid">
            <div class="page-header">
                <h1 class="text-titles">Eliminar Cita Medica de <?php echo $arregloHC[2]; ?></h1>
            </div>
        </div>
            ...
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="zmdi zmdi-delete"></i> &nbsp; DATOS CITA MEDICA
                    </h3>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input class="form-control" type="text" name="FK_DocumentoPropietario"
                                            ...
                                            value="<?php echo $obj->FK_DocumentoPropietario; ?>" readonly maxlength="30">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <br>
                                        <textarea type="text" name="Observacion_CitaMedica" id="Observacion_CitaMedica" rows="7" cols="60" readOnly ><?php echo $obj->Observacion_CitaMedica;?></textarea>
                                    </div>
				    		    </div>
                            </div>
                        </div>
