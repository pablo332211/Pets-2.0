    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h1 class="text-titles">Citas medicas de <?php echo $arregloHC[2] ?></h1>
        ...
        <div class="container-fluid">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="zmdi zmdi-search"></i> &nbsp; Buscar Citma Medica</h3>
                </div>

                <div class="container-fluid">
                    <form method="POST" action="<?php echo "Lista_AgendarCitaHC.php?key=" . urldecode($llave) ?>&DocM<?php echo urldecode($DocM) ?>" class="well">
                        <div class="row">
                            <div class="col-xs-12 col-md-8 col-md-offset-2">
                                <div class="form-group label-floating">
                                    <span class="control-label">Ingrese CODIGO de Cita</span>
                                    <input  pattern="[0-9-]{1,20}" required class="form-control" type="text" name="FK_CodigoCitaMedica" id="FK_CodigoCitaMedica" required="" />
                                    ...
                                    ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="Modificar_CitaMedicaHC.php?key=<?php echo urldecode($arreglo[0]) ?>&CodHC=<?php echo urldecode($arregloHC[0]) ?>&DocM=<?php echo urldecode($DocM) ?>" class="btn btn-success btn-raised btn-xs">
                                                            <i class="zmdi zmdi-check" type="button" name="modificar" value="modificar"></i>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="Eliminar_CitaMedicaHC.php?key=<?php echo urldecode($arreglo[0]) ?>&CodHC=<?php echo urldecode($arregloHC[0]) ?>&DocM=<?php echo urldecode($DocM) ?>" class="btn btn-danger btn-raised btn-xs">
