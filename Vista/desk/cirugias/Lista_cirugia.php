...
$obj->Codigo_Cirugia = $_REQUEST['Codigo_Cirugia'];
if (empty($obj->Codigo_Cirugia)) {
    header("location: Cirugias_HistoriaClinica.php?key=".urldecode($llave).'&DocM='.urldecode($DocM));
}
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from cirugia where Codigo_Cirugia LIKE '$obj->Codigo_Cirugia' ");
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$query = "SELECT * FROM cirugia WHERE Codigo_Cirugia LIKE '$obj->Codigo_Cirugia'";
$resultado = mysqli_query($conecta, $query);
        ...
        <!-- Panel listado de busqueda de propietarios -->
                ...
                <div class="container-fluid">
                    <div class="panel panel-success">
                        ...
                        <form action="" name="propietario" id="" method="POST">
