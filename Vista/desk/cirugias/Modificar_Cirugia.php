        ...
        <div class="container-fluid">
            <div class="page-header">
                ...
                <ul class="breadcrumb breadcrumb-tabs">
                    ...
                    <li>
                        <a href="../medicamentos/Listar_MedicamentoCirugia.php?key=<?php echo urlencode($arregloHC[0])?>&CodC=<?php echo urlencode($CodC)?>&DocM=<?php echo urldecode($DocM)?>" class="btn btn-success">
                            <i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA MEDICAMENTOS
                        </a>
                    </li>
                    <li>
                        <a href="../medicamentos/Agregar_MedicamentoCirugia.php?key=<?php echo urlencode($arregloHC[0])?>&CodC=<?php echo urlencode($CodC)?>&DocM=<?php echo urldecode($DocM)?>" class="btn btn-info">
        ...
        <div class="container-fluid">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="zmdi zmdi-edit"></i>&nbsp;MODIFICAR CIRUGIA</h3>
                </div>
                        ...
                        <fieldset>
                            <div class="container-fluid">
                                <div class="row">
                                            ...
                                            <input class="form-control" type="hidden" id="Codigo_Cirugia" name="Codigo_Cirugia"  readonly value="<?php echo $obj->Codigo_Cirugia;?>" >
                                      
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label"></label>
                                            <input class="form-control" type="date" id="Fecha_Cirugia" name="Fecha_Cirugia"  value="<?php echo $obj->Fecha_Cirugia; ?>">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Nombre del paciente</label>
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" class="form-control" type="text" id="NombrePaciente_Cirugia" name="NombrePaciente_Cirugia" maxlength="45" readonly value="<?php echo $obj->NombrePaciente_Cirugia;?>" >
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Especie</label>
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" class="form-control" type="text" name="Especie_Cirugia" id="Especie_Cirugia" maxlength="45" readonly value="<?php echo $obj->Especie_Cirugia;?>" >
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Raza</label>
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" class="form-control" type="text" name="Raza_Cirugia" id="Raza_Cirugia" maxlength="45" readonly value="<?php echo $obj->Raza_Cirugia?>" >
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Sexo</label>
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" class="form-control" type="text" readonly name="Sexo_Cirugia" id="Sexo_Cirugia" maxlength="45" value="<?php echo $obj->Sexo_Cirugia;?>" >
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Edad</label>
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" class="form-control" type="text" readonly name="Edad_Cirugia" id="Edad_Cirugia" maxlength="45" value="<?php echo $obj->Edad_Cirugia;?>" >
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Peso</label>
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" class="form-control" type="text" name="Peso_Cirugia" id="Peso_Cirugia" maxlength="45" value="<?php echo $obj->Peso_Cirugia;?>">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Tipo de procedimiento</label>
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" class="form-control" type="text" name="TipoProcedimiento_Cirugia" id="TipoProcedimiento_Cirugia" maxlength="45" value="<?php echo $obj->TipoProcedimiento_Cirugia; ?>">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Tipo de anestecia</label>
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" class="form-control" type="text" name="TipoAnestecia_Cirugia" id="TipoAnestecia_Cirugia" maxlength="45" value="<?php echo $obj->TipoAnestecia_Cirugia; ?>">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Nombre del propietario</label>
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" class="form-control" type="text" name="NombrePropietario_Cirugia" id="NombrePropietario_Cirugia" maxlength="45" value="<?php echo $obj->NombrePropietario_Cirugia;?>">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Identificacion</label>
                                            <input pattern="[0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}"  class="form-control" type="text" name="Identificacion_Cirugia" id="Identificacion_Cirugia" maxlength="20" value="<?php echo $obj->Identificacion_Cirugia;?>">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Direccion</label>
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" class="form-control" type="text" name="Direccion_Cirugia" id="Direccion_Cirugia" maxlength="45" value="<?php echo $obj->Direccion_Cirugia;?>">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" class="form-control" type="text" name="PreQuirurgicos" id="PreQuirurgicos" maxlength="45" value="<?php echo $obj->PreQuirurgicos;?>">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Autorizacion</label>
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" class="form-control" type="text" name="AutorizaCirugia_Cirugia" id="AutorizaCirugia_Cirugia" maxlength="45" value="<?php echo $obj->AutorizaCirugia_Cirugia;?>">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Observacion Remision </label>
                                            <textarea class="form-control" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,400}" type="text" name="Observacion_Cirugia" id="Observacion_Cirugia" size="40" rows="7" maxlength="400"><?php echo $obj->Observacion_Cirugia?></textarea>
                                        </div>
                                    </div>
