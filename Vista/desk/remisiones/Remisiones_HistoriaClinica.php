...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from remision where Codigo_Remision ");
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$query = "SELECT * FROM remision, historiaclinica_remision WHERE Codigo_Remision = FK_CodigoRemision AND FK_CodigoHistoriaClinica = '$obj->Codigo_HistoriaClinica' LIMIT $desde,$pag";
$resultado = mysqli_query($conecta, $query);
            ...
            <div class="container-fluid">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="zmdi zmdi-search"></i> &nbsp; Buscar Remision</h3>
                    </div>


                    <div class="container-fluid">

                        <form method="POST" action="<?php echo "Lista_Remisiones.php?key=" . urldecode($llave) ?>&DocM<?php echo urldecode($DocM) ?>" class="well">
                            <div class="row">
                                <div class="col-xs-12 col-md-8 col-md-offset-2">
                                    <div class="form-group label-floating">
                                        <span class="control-label">Ingrese Codigo de Remision</span>
                                        <input class="form-control" type="text" name="Codigo_Remision" id="Codigo_Remision" required="" />
