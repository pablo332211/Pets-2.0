...
include "../../../Modelo/modelo_HistoriaClinicaRemision.php";
    ...
    if ($_POST) {
        //HISTORIA CLINICA REMISION
        $obj->FK_CodigoRemision = $_POST['Codigo_Remision'];
    ...
    if (isset($_POST['eliminar'])) {
        //HISTORIA CLINICA REMISION
        $obj->FK_CodigoRemision = "";
        //REMISION
        $obj->Codigo_Remision = "";
        $obj->Fecha_Remision = "";
        $obj->Especialista_Remision = "";
        $obj->Celular_Remision = "";
        $obj->Entidad_Remision = "";
        $obj->Observacion_Remision = "";
    }else{
        $clas = new Conexion();
        $conecta = $clas->conectarServidor();
    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h1 class="text-titles">Eliminar Remision de <?php echo $arregloHC[2] ?></h1>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="zmdi zmdi-delete"></i>&nbsp;DATOS REMISION</h3>
                </div>
                <div class="panel-body">
                    <form action="" method="POST" id="">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" type="text" name="Codigo_Remision" id="Codigo_Remision" value="<?php echo $obj->Codigo_Remision ?>" readOnly >
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Fecha</label>
                                            <input class="form-control" type="date" name="Fecha_Remision" id="Fecha_Remision" value="<?php echo $obj->Fecha_Remision ?>" readOnly  >
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Especialista</label>
                                            <input class="form-control" type="text" name="Especialista_Remision" id="Especialista_Remision" value="<?php echo $obj->Especialista_Remision ?>" maxlength="100" readOnly  >
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Celular</label>
                                            <input class="form-control" type="text" name="Celular_Remision" id="Celular_Remision" value="<?php echo $obj->Celular_Remision ?>" maxlength="45" readOnly  >
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Entidad</label>
                                            <input class="form-control" type="text" name="Entidad_Remision" id="Entidad_Remision" value="<?php echo $obj->Entidad_Remision ?>" maxlength="100" readOnly  >
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Observacion Remision </label>
                                            <textarea class="form-control" type="text" name="Observacion_Remision" id="Observacion_Remision" size="40" rows="7" readOnly maxlength="400"><?php echo $obj->Observacion_Remision; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <p class="text-center" style="margin-top: 20px;">
                                <input type="hidden" name="FK_CodigoFormulaMedica" id="FK_CodigoFormulaMedica" value="<?php echo $arregloHC[0]; ?>" readOnly size="30">
                                <input type="hidden" name="FK_CodigoRemision" id="FK_CodigoRemision" value="<?php echo $obj->Codigo_Remision;?>" readOnly size="30">
                            <button name="eliminar" type="submit" class="btn btn-danger btn-raised btn-m">ELIMINAR</button>
                        </p>
                    </form>
                </div>
            </div>
