    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h1 class="text-titles">Eliminar Cita Medica</h1>
            </div>
        </div>
        <!--cita medica -->
        <div class="container-fluid">
                    ...
                    <form method="POST" id="cita_medica">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                type="text" id="Codigo_CitaMedica" name="Codigo_CitaMedica"
                                                value="<?php echo $obj->Codigo_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->FK_DocumentoMedico; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->TipoCita_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Oidos_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->FrecCardiaca_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Ojos_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Auscultacion_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->FrecRespiratoria_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Mucosas_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Peso_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Tilc_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Ganglios_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Palpitacion_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->CavidadOral_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Nervioso_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Temperatura_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Tegumento_CitaMedica; ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <textarea pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" type="text"
                                                ...
                                                rows="7" cols="60"
                                                readOnly><?php echo $obj->Observacion_CitaMedica; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <p class="text-center" style="margin-top: 20px;">
                            <button type="submit" name="eliminar" id="eliminar"
                                class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-"></i>Eliminar Historia
                                Clinica</button>
                        </p>
                    </form>
                </div>
