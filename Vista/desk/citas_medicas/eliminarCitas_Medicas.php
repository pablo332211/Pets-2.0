...
if (isset($_POST['eliminar'])) {
    ...
    $query = "SELECT * FROM cita_medica WHERE Codigo_CitaMedica = '$llave'";
        ...
        <div class="container-fluid">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="zmdi zmdi-plus"></i> &nbsp; ELIMINAR HISTORIA CLINICA</h3>
                </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Codigo_CitaMedica; ?>" maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <textarea pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" type="text"
                                                ...
                                                rows="7" cols="60" value="<?php echo $obj->Observacion_CitaMedica; ?>"
                                                required></textarea>
                                        </div>
                                    </div>
                                </div>
