...
<?php
    ...
    if($_POST){
        ...
        if(isset($_POST['eliminarMedCir'])){
            ...
            $obj->Dosis_MedicamentoCirugia = "";
            $obj->Administracion_MedicamentoCirugia = "";
            $obj->Observacion_MedicamentoCirugia = "";
        }
        else{
    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
                    <h1 class="text-titles">Eliminar Medicamento</h1>
        </div>
            <div class="container-fluid">
                                    ...
                                    <tr>
                                        ...
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <input class="form-control" type="text" name="Presentacion_Medicamento" id="Presentacion_Medicamento" value="<?php echo $obj->Presentacion_Medicamento?>" readOnly size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                    ...
                                    <tr>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <input class="form-control" type="text" name="Dosis_MedicamentoCirugia" id="Dosis_MedicamentoCirugia" value="<?php echo $obj->Dosis_MedicamentoCirugia?>" readOnly size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Administracion Medicamento</label>
                                                <input class="form-control" type="text" name="Administracion_MedicamentoCirugia" id="Administracion_MedicamentoCirugia" value="<?php echo $obj->Administracion_MedicamentoCirugia?>" readOnly size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Observacion Medicamento </label>
                                                <textarea class="form-control" type="text-area" name="Observacion_MedicamentoCirugia" id="Observacion_MedicamentoCirugia"rows="7" cols="60" readOnly required ><?php echo $obj->Observacion_MedicamentoCirugia?></textarea>
                                            </div>
                                        </div>
                                            ...
                                            <td><button class="btn btn-info btn-raised btn-sm" name="eliminarMedCir" type="submit">Eliminar Medicamento</button></td> 
                                    </tr>
                                </table>
                            </div>
                        </div>
