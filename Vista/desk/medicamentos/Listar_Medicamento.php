...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from medicamento m INNER JOIN formulamedica_medicamento fm WHERE fm.FK_CodigoFormulaMedica = '$CodFM' AND fm.FK_CodigoMedicamento = m.Codigo_Medicamento");
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$query = "SELECT m.Codigo_Medicamento,m.Nombre_Medicamento,fm.Dosis_Medicamento,fm.Observacion_Medicamento FROM medicamento m INNER JOIN formulamedica_medicamento fm WHERE fm.FK_CodigoFormulaMedica = '$CodFM' AND fm.FK_CodigoMedicamento = m.Codigo_Medicamento LIMIT $desde,$pag";
$resultado = mysqli_query($conecta, $query);
            ...
            <div class="container-fluid">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="zmdi zmdi-search"></i> &nbsp; Buscar Medicamento de Formula Medica</h3>
                    </div>
                        ...
                        <div class="panel-body">
                            ...
                            <nav class="text-center">
                                <ul class="pagination pagination-sm">
                                    <li class=""><a href="?&DocM=<?php echo $DocM ?>&CodHC=<?php echo $CodHC ?>&CodFM=<?php echo $CodFM ?>&pagina=<?php echo $pagina - 1; ?>">«</a></li>
                                    ...
                                    for ($i = 1; $i <= $total_paginas; $i++) {
                                        ...
                                        echo '<li class=""><a href="?&DocM=' . $DocM . "&CodHC=" . $CodHC . "&CodFM=" . $CodFM . '&pagina=' . $i . '">' . $i . '</a></li>';
                                    }
