...
<?php
    ...
    if($_POST){
        ...
        if(isset($_POST['eliminar'])){
            ...
            $obj->FK_CodigoFormulaMedica = "";
            $obj->FK_CodigoMedicamento = "";
            $obj->Dosis_Medicamento = "";
            $obj->FK_CodigoAdministracion = "";
            $obj->Observacion_Medicamento = "";
        }
        else{
    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
                    <h1 class="text-titles">Eliminar Medicamento de <?php echo $arregloHC[2];?></h1>
        </div>
            <div class="container-fluid">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="zmdi zmdi-delete"></i> &nbsp; DATOS DE MEDICAMENTO </h3>
                    </div>
                    <form method="POST">
                                    ...
                                    <tr>
                                        ...
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <input class="form-control" type="text" name="Nombre_Medicamento" id="Nombre_Medicamento" value="<?php echo$obj->Nombre_Medicamento?>" readOnly size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                if($presentacion > 1){
                                                    do {
                                                ?>
                                                        <input type="hidden" name="FK_CodigoPresentacion" id="FK_CodigoPresentacion" readOnly value="<?php echo $presentacion[0];?>" maxlength="40">
                                                        <input class="form-control" type="text"readOnly value="<?php echo $presentacion[1];?>" maxlength="40">   
                                                <?php
                                        ...
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <input class="form-control" type="text" name="Tipo_Medicamento" id="Tipo_Medicamento" value="<?php echo $obj->Tipo_Medicamento?>" readOnly size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Concentracion Medicamento </label>
                                                <input class="form-control" type="text" name="Concentracion_Medicamento" id="Concentracion_Medicamento" value="<?php echo $obj->Concentracion_Medicamento?>" readOnly size="40">
                                            </div>
                                        </div>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <input class="form-control" type="text" name="Dosis_Medicamento" id="Dosis_Medicamento" value="<?php echo $obj->Dosis_Medicamento?>" readOnly size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                ?>
                                                        ...
                                                        <input class="form-control" type="text"readOnly value="<?php echo $administracion[1];?>" maxlength="40">   
                                                <?php
                                        ...
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <textarea class="form-control" type="text-area" name="Observacion_Medicamento" id="Observacion_Medicamento"rows="7" cols="60" readOnly required ><?php echo $obj->Observacion_Medicamento?></textarea>
                                            </div>
                                        </div>
                                            ...
                                            <td><button class="btn btn-danger btn-raised btn-sm" name="eliminar" type="submit">Eliminar Medicamento</button></td> 
                                    </tr>
                                </table>
                            </div>
                        </div>
