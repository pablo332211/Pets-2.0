    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h1 class="text-titles">EXAMENES <?php echo $obj->Nombre_Mascota?></h1><!-- debe cambiar el nombre en relacion al perfil cagado-->
            </div>
        </div>
        <div class="full-box text-center" style="padding: 5px 5px;">

            <article class="full-box tile">
                <a href="Listar_ExamenHC.php?key=<?php echo urldecode($arregloHC[0])?>&DocM=<?php echo urldecode($DocM)?>">
            ...
            <article class="full-box tile">
                <a href="Listar_PruebaLaboratorioHC.php?key=<?php echo urldecode($arregloHC[0])?>&DocM=<?php echo urldecode($DocM)?>">
                    <div class="full-box tile-title text-center text-titles text-uppercase">
                        Prueba Laboratorio
                    </div>
                    <div class="full-box tile-icon text-center">
                    ...
                    <div class="full-box tile-number text-titles">
                        ...
                        <small>Prueba Laboratorio</small>
                    </div>
                </a>
            </article>
