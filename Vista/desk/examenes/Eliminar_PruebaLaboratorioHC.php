...
<?php
    ...
    if(isset($_POST['eliminar'])){
        $obj->Codigo_PruebaLaboratorio = "";
        $obj->Nombre_PruebaLaboratorio = "";
        $obj->Tipo_PruebaLaboratorio = "";
        $obj->Fecha_PruebaLaboratorio = "";
        $obj->Laboratorio_PruebaLaboratorio = "";
        $obj->Resultado_PruebaLaboratorio = "";
    }
    else{
        $CodPL = $_GET['CodPL'];
        ...
        <div class="container-fluid">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="zmdi zmdi-delete"></i> &nbsp; Eliminar Prueba de Laboratorio </h3>
                    </div>
                    <form method="POST">
                                    ...
                                    <tr>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <input class="form-control" type="text" name="Codigo_PruebaLaboratorio" id="Codigo_PruebaLaboratorio" value="<?php echo  $obj->Codigo_PruebaLaboratorio?>" readOnly size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Nombre de la Prueba Laboratorio </label>
                                                <input class="form-control" type="text" name="Nombre_PruebaLaboratorio" id="Nombre_PruebaLaboratorio" value="<?php echo $obj->Nombre_PruebaLaboratorio?>" readOnly size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Tipo de Prueba Laboratorio </label>
                                                <input class="form-control" type="text" name="Tipo_PruebaLaboratorio" id="Tipo_PruebaLaboratorio" value="<?php echo $obj->Tipo_PruebaLaboratorio?>" readOnly size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                <input class="form-control" type="date" name="Fecha_PruebaLaboratorio" id="Fecha_PruebaLaboratorio" value="<?php echo $obj->Fecha_PruebaLaboratorio?>" readOnly size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Laboratorio Realizado </label>
                                                <input class="form-control" type="text" name="Laboratorio_PruebaLaboratorio" id="Laboratorio_PruebaLaboratorio" value="<?php echo $obj->Laboratorio_PruebaLaboratorio?>" readOnly size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Resultados del Examen </label>
                                                <textarea class="form-control" type="text" name="Resultado_PruebaLaboratorio" id="Resultado_PruebaLaboratorio"size="40" rows="7" cols="60" readOnly><?php echo $obj->Resultado_PruebaLaboratorio?></textarea>
                                            </div>
                                        </div>
                                        <input type="hidden" name="FK_CodigoHistoriaClinica" id="FK_CodigoHistoriaClinica" value="<?php echo $CodHC?>" readOnly size="30">
                                        <input type="hidden" name="FK_CodigoPruebaLaboratorio" id="FK_CodigoPruebaLaboratorio" value="<?php echo $obj->Codigo_PruebaLaboratorio?>" readOnly size="30">
                                        <td><button class="btn btn-danger btn-raised btn-sm" name="eliminar" type="submit">ELIMINAR PRUEBA</button></td>                                    
                                    </tr>
                                </table>
                            </div>
                        </div>
