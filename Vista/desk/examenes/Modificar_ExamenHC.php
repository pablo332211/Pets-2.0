    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
                    <h1 class="text-titles">Modificar Exemen de <?php echo $arregloHC[2]; ?></h1>
        </div>
            ...
            <div class="container-fluid">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="zmdi zmdi-edit"></i> &nbsp;Datos del Examen </h3>
                    </div>
                    <form method="POST">
                                    ...
                                    <tr>
                                        ...
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <input class="form-control" type="text"   pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" maxlength="45" name="Tipo_Examen" id="Tipo_Examen" value="<?php echo $obj->Tipo_Examen?>"  size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Correo Examen </label>
                                                <input class="form-control" type="email" name="Correo_Examen" id="Correo_Examen" maxlength="45" value="<?php echo $obj->Correo_Examen?>"  size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Resultado Examen  </label>
                                                <input class="form-control" type="text"  pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" maxlength="45" name="Resultado_Examen" id="Resultado_Examen" value="<?php echo $obj->Resultado_Examen?>"  size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Observacion Examen  </label>
                                                <textarea class="form-control" type="text"  pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,45}" maxlength="400"  name="Observacion_Examen" id="Observacion_Examen" size="40" rows="7"> <?php echo $obj->Observacion_Examen?></textarea>
                                            </div>
                                        </div>
                                        <td><button class="btn btn-info btn-raised btn-sm" name="modificar" type="submit">Modificar Examen</button></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
