...
$obj->Codigo_Examen = $_REQUEST['Codigo_Examen'];
if (empty($obj->Codigo_Examen)) {
    header("location: Listar_ExamenHC.php?key=".urldecode($llave).'&DocM='.urldecode($DocM));
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from examen where Codigo_Examen LIKE '$obj->Codigo_Examen'");
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$query = "SELECT * FROM examen, historiaclinica_examen WHERE Codigo_Examen LIKE '$obj->Codigo_Examen' AND FK_CodigoHistoriaClinica = '$obj->Codigo_HistoriaClinica' GROUP BY '$obj->Codigo_Examen' ";
$resultado = mysqli_query($conecta, $query);
    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h1 class="text-titles">Examen de <?php echo $arregloHC[2] ?></h1>
