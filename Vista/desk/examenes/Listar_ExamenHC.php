...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from examen where Codigo_Examen ");
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$query = "SELECT * FROM examen, historiaclinica_examen WHERE Codigo_Examen = FK_CodigoExamen AND FK_CodigoHistoriaClinica = '$obj->Codigo_HistoriaClinica' LIMIT $desde,$pag";
$resultado = mysqli_query($conecta, $query);
    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
                <h1 class="text-titles">Examenes <?php echo $arregloHC[2] ?></h1>
        ...
        <div class="container-fluid">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="zmdi zmdi-search"></i> &nbsp; Buscar Examen</h3>
                </div>


                <div class="container-fluid">

                    <form method="POST" action="<?php echo "Lista_ExamenHC.php?key=".urldecode($llave)?>&DocM<?php echo urldecode($DocM) ?>" class="well">
                        <div class="row">
                            <div class="col-xs-12 col-md-8 col-md-offset-2">
                                <div class="form-group label-floating">
                                    <span class="control-label">Ingrese CODIGO de Examen</span>
                                    <input class="form-control" type="text" name="Codigo_Examen" id="Codigo_Examen" pattern="[0-9-]{1,20}" required="" />
                ...
                <div class="container-fluid">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE EXAMEN</h3>
                        </div>
                                    ...
                                    ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="Modificar_ExamenHC.php?CodHC=<?php echo urlencode($arregloHC[0]) ?>&CodE=<?php echo urlencode($arreglo[0]) ?>&DocM=<?php echo urldecode($DocM) ?>" class="btn btn-success btn-raised btn-xs">
                                                            <i class="zmdi zmdi-check" type="button" name="modificar" value="modificar"></i>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="Eliminar_ExamenHC.php?CodHC=<?php echo urlencode($arregloHC[0]) ?>&CodE=<?php echo urlencode($arreglo[0]) ?>&DocM=<?php echo urldecode($DocM) ?>" class="btn btn-danger btn-raised btn-xs">
