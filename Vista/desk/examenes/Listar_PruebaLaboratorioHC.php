...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from prueba_laboratorio where Codigo_PruebaLaboratorio ");
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$query = "SELECT * FROM prueba_laboratorio, historiaclinica_pruebalaboratorio WHERE Codigo_PruebaLaboratorio = FK_CodigoPruebaLaboratorio AND FK_CodigoHistoriaClinica = '$obj->Codigo_HistoriaClinica' LIMIT $desde,$pag";
$resultado = mysqli_query($conecta, $query);
        ...
        <div class="container-fluid">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="zmdi zmdi-search"></i> &nbsp; Buscar Prueba de laboratorio</h3>
                </div>


                <div class="container-fluid">

                    <form method="POST" action="<?php echo "Lista_PruebaLaboratorio.php?key=" . urldecode($llave) ?>&DocM<?php echo urldecode($DocM) ?>" class="well">
                        <div class="row">
                            <div class="col-xs-12 col-md-8 col-md-offset-2">
                                <div class="form-group label-floating">
                                    <span class="control-label">Ingrese CODIGO de Prueba Laboratoio</span>
                                    <input class="form-control" type="text" name="Codigo_PruebaLaboratorio" id="Codigo_PruebaLaboratorio" required="" />
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA PRUEBAS DE LABORATORIO</h3>
                    </div>
