...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from profilactico GROUP BY Codigo_Profilactico");
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$query = "SELECT p.Codigo_Profilactico, p.Nombre_Profilactico,p.Presentacion_Profilactico,pm.Dosis_ProfilacticoMascota,pm.Observacion_ProfilacticoMascota FROM profilactico p INNER JOIN profilactico_mascota pm WHERE pm.FK_CodigoMascota ='$arregloHC[1]' AND p.Codigo_Profilactico = pm.FK_CodigoProfilactico LIMIT $desde,$pag";
$resultado = mysqli_query($conecta, $query);
        ...
        <div class="container-fluid">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="zmdi zmdi-search"></i> &nbsp; Buscar Profilactico</h3>
                </div>

                <div class="container-fluid">
                    <form method="POST" action="<?php echo "VacunacionDesparacitacion_HistoriaClinica_Lista.php?key=" . urldecode($llave) ?>&DocM<?php echo urldecode($DocM) ?>" class="well">
                        <div class="row">
                            <div class="col-xs-12 col-md-8 col-md-offset-2">
                                <div class="form-group label-floating">
                                    <span class="control-label">Ingrese CODIGO de Profilactico</span>
                                    <input class="form-control" type="text" name="Codigo_Profilactico" id="Codigo_Profilactico" required="" />
                                ...
                                ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="Modificar_ProfilacticoHC.php?CodHC=<?php echo urlencode($arregloHC[0]); ?>&CodFM=<?php echo urlencode($arregloFM[0]); ?>&DocM=<?php echo urldecode($DocM) ?>">
                                                ...
                                                <td>
                                                    <a href="Eliminar_ProfilacticoHC.php?CodHC=<?php echo urlencode($arregloHC[0]); ?>&CodFM=<?php echo urlencode($arregloFM[0]); ?>&DocM=<?php echo urldecode($DocM) ?>">
