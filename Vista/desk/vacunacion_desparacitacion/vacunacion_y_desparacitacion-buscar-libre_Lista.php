...
$obj->FK_CodigoMascota = $_GET['FK_CodigoMascota'];
if (empty($obj->FK_CodigoMascota)) {
    header("location: vacunacion_y_desparacitacion-buscar-libre.php?&DocM=" . urldecode($DocM));
}
...
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from profilactico_mascota WHERE FK_CodigoMascota LIKE '$obj->FK_CodigoMascota'");
