            ...
            <div class="full-box dashboard-sideBar-ct">
                ...
                <div class="full-box dashboard-sideBar-UserInfo">
                    ...
                    <ul class="full-box list-unstyled text-center">
                        ...
                        <li>
                            <a href="<?php echo "vacunacion_y_desparacitacion-buscar-libre.php?DocM=".urldecode($DocM)?>" title="Profilacticos">
                                    ...
                                    <div class=" col-xs-12 col-sm-6">
                                        <div class=" form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Dosis_ProfilacticoMascota ?>" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->Administracion_ProfilacticoMascota?>" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Observacion Medicamento </label>
                                            <textarea pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control" type="text-area" name="Observacion_ProfilacticoMascota" id="Observacion_ProfilacticoMascota"  rows="7" cols="60" required   maxlength="400"><?php echo $obj->Observacion_ProfilacticoMascota?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
