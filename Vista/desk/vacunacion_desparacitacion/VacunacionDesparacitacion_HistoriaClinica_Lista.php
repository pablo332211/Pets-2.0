...
$obj->Codigo_Profilactico = $_REQUEST['Codigo_Profilactico'];
if (empty($obj->Codigo_Profilactico)) {
    header("location: VacunacionDesparacitacion_HistoriaClinica.php?key=".urldecode($llave).'&DocM='.urldecode($DocM));
}
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from profilactico WHERE Codigo_Profilactico LIKE '$obj->Codigo_Profilactico'");
