...
if(isset($_POST['eliminar'])){
    ...
    $clas = new Conexion();
    $conecta = $clas->conectarServidor();
    $query = "SELECT * FROM profilactico_mascota WHERE FK_CodigoProfilactico = '$CodFM'";
    echo $query;
    $resultado = mysqli_query($conecta,$query);
        ...
        <div class="container-fluid">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="zmdi zmdi-delete"></i> &nbsp; ELIMINAR PROFILACTICOS</h3>
                </div>
                    ...
                    <form method="POST" id="">
                                    ...
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->FK_CodigoMascota ?>"
                                                placeholder="Ingrese Codigo Formula Medica" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                ...
                                                value="<?php echo $obj->FK_CodigoProfilactico ?>"
                                                placeholder="Ingrese Nombre Medicamento" size="40">
                                        </div>
                                    </div>
                                    <div class=" col-xs-6 col-sm-6">
                                            <div class=" form-group label-floating">
                                                ...
                                                <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                    type="text" name="Dosis_ProfilacticoMascota"
                                                    id="Dosis_ProfilacticoMascota"
                                                    value="<?php echo $obj->Dosis_ProfilacticoMascota ?>"
                                                    placeholder="Ingrese Dosis" size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <input pattern="[0-9-]{1,30}" class="form-control" type="date"
                                                    name="Fecha_ProfilacticoMascota" id="Fecha_ProfilacticoMascota"
                                                    value="<?php echo $obj->Fecha_ProfilacticoMascota ?>" required="" maxlength="30">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <input pattern="[a-zA-Z0-9áéíóúÁÉÍTipoÓÚñÑ ]{1,40}" class="form-control"
                                                    ...
                                                    value="<?php echo $obj->Administracion_ProfilacticoMascota ?>"
                                                    placeholder="Administracion" size="40">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <textarea type="text" name="Observacion_ProfilacticoMascota"
                                                    id="Observacion_ProfilacticoMascota" size="40"
                                                    rows="7" cols="60" required> <?php echo $obj->Observacion_ProfilacticoMascota ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <p class="text-center" style="margin-top: 20px;">
                            <button type="submit" name="eliminar" id="eliminar"
                                class="btn btn-danger btn-raised btn-sm"><i class="zmdi zmdi-"></i>Eliminar
                                Profilactico</button>
                        </p>
                    </form>
                </div>
