...
$DocM = $_REQUEST['DocM'];
$obj->Documento_Propietario = $_GET['Documento_Propietario'];
if (empty($obj->Documento_Propietario)) {
    header("location: Listar_Propietario.php?&DocM=" . urldecode($DocM));
}
...
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from propietario where Documento_Propietario LIKE '$obj->Documento_Propietario' ");
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$query = "SELECT * FROM propietario WHERE Documento_Propietario  LIKE '$obj->Documento_Propietario'";
