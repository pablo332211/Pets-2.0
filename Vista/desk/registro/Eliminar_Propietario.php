...
if(isset($_POST['eliminar'])){
        $obj->Documento_Propietario = "";
        $obj->NombreA_Propietario = "";
        $obj->NombreB_Propietario = "";
        $obj->ApellidoA_Propietario = "";
        $obj->ApellidoB_Propietario = "";
        $obj->Direccion_Propietario = "";
        $obj->Telefono_Propietario = "";
        $obj->Celular_Propietario = "";
        ...
        <div class="container-fluid">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="zmdi zmdi-delete"></i>&nbsp;DATOS PROPIETARIO</h3>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" type="text" name="NombreA_Propietario" id="NombreA_Propietario" value="<?php echo $obj->NombreA_Propietario ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Segundo Nombre</label>
                                            <input class="form-control" type="text" name="NombreB_Propietario" id="NombreB_Propietario" value="<?php echo $obj->NombreB_Propietario ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Primer Apellido</label>
                                            <input class="form-control" type="text" name="ApellidoA_Propietario" id="ApellidoA_Propietario" value="<?php echo $obj->ApellidoA_Propietario ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Segundo Apellido</label>
                                            <input class="form-control" type="text" name="ApellidoB_Propietario" id="ApellidoB_Propietario" value="<?php echo $obj->ApellidoB_Propietario ?>" readOnly maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Dirección</label>
                                            <input class="form-control" type="text" name="Direccion_Propietario" id="Direccion_Propietario" value="<?php echo $obj->Direccion_Propietario ?>" readOnly maxlength="170">
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Teléfono</label>
                                            <input class="form-control" type="number" name="Telefono_Propietario" id="Telefono_Propietario" value="<?php echo $obj->Telefono_Propietario ?>" readOnly maxlength="15">
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Celular</label>
                                            <input class="form-control" type="number" name="Celular_Propietario" id="Celular_Propietario" value="<?php echo $obj->Celular_Propietario ?>" readOnly maxlength="15">
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Correo_Propietario</label>
                                            <input class="form-control" type="text" name="Correo_Propietario" id="Correo_Propietario" value="<?php echo $obj->Correo_Propietario ?>" readOnly maxlength="50">
                                        </div>
                                    </div>
                                </div>
                            </div>
