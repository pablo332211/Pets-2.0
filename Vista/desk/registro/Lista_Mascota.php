...
if (empty($obj->FK_DocumentoPropietario)) {
    header("location: Listar_Mascota.php?&DocM=" . urldecode($DocM));
}
...
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from mascota where FK_DocumentoPropietario LIKE '$obj->FK_DocumentoPropietario' ");
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$query = "SELECT * FROM mascota WHERE FK_DocumentoPropietario LIKE '$obj->FK_DocumentoPropietario'";
                ...
                <ul class="breadcrumb breadcrumb-tabs">
                    ...
                    <li>
                        <a href="<?php echo "Listar_Propietario.php?DocM=" . urldecode($DocM) ?>" class="btn btn-info">
                            <i class="zmdi zmdi-plus"></i> &nbsp; LISTAR PROPIETARIO
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo "Listar_Mascota.php?DocM=" . urldecode($DocM) ?>" class="btn btn-info">
                            <i class="zmdi zmdi-plus"></i> &nbsp; LISTAR MASCOTA
                        </a>
                    </li>
                </ul>
            </div>
