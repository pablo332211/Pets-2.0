...
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from propietario where Documento_Propietario ");
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$query = "SELECT * FROM propietario WHERE Documento_Propietario LIMIT $desde,$pag";
        ...
        <div class="container-fluid">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="zmdi zmdi-search"></i> &nbsp; Buscar propietario</h3>
                </div>

                <div class="container-fluid">

                    <form class="well" method="GET" action="<?php echo "lista_Propietario.php?&DocM=" . urldecode($DocM) ?>">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-8 col-md-offset-2">
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" type="text" name="Documento_Propietario" id="Documento_Propietario" value="<?php echo $obj->Documento_Propietario;  ?>" />
                    ...
                    <div class="container-fluid">
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE PROPIETARIO</h3>
                            </div>
                                    ...
                                    <table class="table table-hover text-center">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">DOCUMENTO PROPIETARIO</th>
                                        ...
                                        ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="Modificar_Propietario.php?key=<?php echo urlencode($arreglo[0]) ?>&DocM=<?php echo urlencode($DocM) ?>" class="btn btn-success btn-raised btn-xs">
                                                                <i class="zmdi zmdi-edit" type="button" name="modificar" value="modificar"></i>
                                                            </a>
                                                        </td>
                                                        <td>
                                                            <a href="Eliminar_Propietario.php?key=<?php echo urlencode($arreglo[0]) ?>&DocM=<?php echo urlencode($DocM) ?>" class="btn btn-danger btn-raised btn-xs">
