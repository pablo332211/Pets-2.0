...
$obj->FK_EspecieMascota = $arreglo[3];
$obj->Color_Mascota = $arreglo[4];
$obj->Edad_Mascota = $arreglo[5];
$obj->FK_GeneroMascota = $arreglo[6];
        ...
        <div class="container-fluid">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="zmdi zmdi-edit"></i>&nbsp;DATOS DE LA MASCOTA</h3>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" type="text" name="Nombre_Mascota" id="Nombre_Mascota" value="<?php echo $obj->Nombre_Mascota;?>" maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                    ...
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" type="text" name="Color_Mascota" id="Color_Mascota" value="<?php echo $obj->Color_Mascota;?>" maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Edad</label>
                                            <input class="form-control" type="text" name="Edad_Mascota" id="Edad_Mascota" value="<?php echo $obj->Edad_Mascota;?>" maxlength="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                    ...
                                    <div class="col-xs-4 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" type="text" name="Observacion_Mascota" id="Observacion_Mascota" value="<?php echo $obj->Observacion_Mascota;?>" maxlength="15">
                                        </div>
                                    </div>
                                </div>
                            </div>
