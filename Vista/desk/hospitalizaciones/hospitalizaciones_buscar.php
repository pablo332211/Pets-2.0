...
$obj->Codigo_Hospitalizacion = $_REQUEST['Codigo_Hospitalizacion'];
if (empty($obj->Codigo_Hospitalizacion)) {
    header("location: Hospitalizaciones_HistoriaClinica.php?key=".urldecode($llave).'&DocM='.urldecode($DocM));
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$sql_register = mysqli_query($conecta, "SELECT COUNT(*) AS total_registros from hospitalizacion where Codigo_Hospitalizacion LIKE '$obj->Codigo_Hospitalizacion'");
...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$query = "SELECT * FROM hospitalizacion, historiaclinica_hospitalizacion WHERE Codigo_Hospitalizacion LIKE '$obj->Codigo_Hospitalizacion' AND FK_CodigoHistoriaClinica = '$obj->Codigo_HistoriaClinica' GROUP BY '$obj->Codigo_Hospitalizacion'";
$resultado = mysqli_query($conecta, $query);
