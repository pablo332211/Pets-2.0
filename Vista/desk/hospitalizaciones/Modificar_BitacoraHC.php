        ...
        <div class="container-fluid">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="zmdi zmdi-edit"></i> &nbsp; MODIFICAR BITACORA</h3>
                    </div>
                    <form method="POST">
                                ...
                                <table class="table table-hover text-center">
                                    ...
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" type="text" maxlength="100" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ_ ]{1,100}" required name="FormMedTratada_Bitacora" id="FormMedTratada_Bitacora" value="<?php echo $obj->FormMedTratada_Bitacora?>" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Temperatura</label>
                                            <input class="form-control" type="text" maxlength="45" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ_ ]{1,45}" required name="Temperatura_Bitacora" id="Temperatura_Bitacora" value="<?php echo $obj->Temperatura_Bitacora?>" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Frecuencia Cardiaca</label>
                                            <input class="form-control" type="text" maxlength="45" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ_ ]{1,45}" required name="FrecCardiaca_Bitacora" id="FrecCardiaca_Bitacora" value="<?php echo $obj->FrecCardiaca_Bitacora ?>" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Frecuencia Respiratoria</label>
                                            <input class="form-control" type="text" maxlength="45" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ_ ]{1,45}" required name="FrecRespiratoria_Bitacora" id="FrecRespiratoria_Bitacora" value="<?php echo $obj->FrecRespiratoria_Bitacora?>" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Color Mucosa</label>
                                            <input class="form-control" type="text" maxlength="45" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ_ ]{1,45}" required name="ColorMucosa_Bitacora" id="ColorMucosa_Bitacora" value="<?php echo $obj->ColorMucosa_Bitacora?>" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Apetito</label>
                                            <input class="form-control" type="text" maxlength="45" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ_ ]{1,45}" required name="Apetito_Bitacora" id="Apetito_Bitacora" value="<?php echo $obj->Apetito_Bitacora?>" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Sed</label>
                                            <input class="form-control" type="text" maxlength="45" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ_ ]{1,45}" required name="Sed_Bitacora" id="Sed_Bitacora" value="<?php echo $obj->Sed_Bitacora?>" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Estado Animo</label>
                                            <input class="form-control" type="text" maxlength="45" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ_ ]{1,45}" required name="EstadoAnimo_Bitacora" id="EstadoAnimo_Bitacora" value="<?php echo $obj->EstadoAnimo_Bitacora?>" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Vomito </label>
                                            <input class="form-control" type="text" maxlength="45" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ_ ]{1,45}" required name="Vomito_Bitacora" id="Vomito_Bitacora" value="<?php echo $obj->Vomito_Bitacora?>" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Orina</label>
                                            <input class="form-control" type="text" maxlength="45" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ_ ]{1,45}" required name="Orina_Bitacora" id="Orina_Bitacora" value="<?php echo $obj->Orina_Bitacora?>" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Grado Hidratacion</label>
                                            <input class="form-control" type="text" maxlength="45" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ_ ]{1,45}" required name="GradoHidratacion_Bitacora" id="GradoHidratacion_Bitacora" value="<?php echo $obj->GradoHidratacion_Bitacora?>" size="40">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Observacion</label>
                                            <textarea class="form-control" type="text" maxlength="200" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ_ ]{1,200}" required name="Observacion_Bitacora" id="Observacion_Bitacora" size="40" rows="7"><?php echo $obj->Observacion_Bitacora?></textarea>
                                        </div>
                                    </div>                             
                                        <td><button class="btn btn-info btn-raised btn-sm" name="modificar" type="submit">MODIFICAR BITACORA</button></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
