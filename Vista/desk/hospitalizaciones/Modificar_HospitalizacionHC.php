...
$clas = new conexion();
$conecta = $clas->conectarServidor();
$query = "SELECT * FROM bitacora, hospitalizacion_bitacora WHERE Codigo_Bitacora = FK_CodigoBitacora AND FK_CodigoHospitalizacion = '$obj->Codigo_Hospitalizacion' LIMIT $desde,$pag";
$resultado = mysqli_query($conecta, $query);
$arreglo = mysqli_fetch_row($resultado);
?>
                ...
                <div class="panel-body">
                    ...
                    <nav class="text-center">
                        <ul class="pagination pagination-sm">
                            <li class=""><a href="?&DocM=<?php echo $DocM ?>&key=<?php echo $llave ?>&CodH=<?php echo $CodH ?> &pagina=<?php echo $pagina - 1; ?>">«</a></li>
                            ...
                            for ($i = 1; $i <= $total_paginas; $i++) {
                                ...
                                echo '<li class=""><a href="?&DocM=' . $DocM . "&key=" . $llave . "&CodH=" . $CodH . '&pagina=' . $i . '">' . $i . '</a></li>';
                            }
